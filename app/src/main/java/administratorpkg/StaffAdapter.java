...
public class StaffAdapter extends RecyclerView.Adapter<StaffAdapter.StaffViewHolder> implements recyclerviewonclick
{
    recyclerviewonclick recyclerviewonclick;
    Context context;
    ArrayList<Staff> staffArrayList;

    public StaffAdapter(Context context,ArrayList<Staff> staff , recyclerviewonclick recyclerviewonclick) {
    ...
    public StaffViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.listview_item,parent,false);
    ...
    public class StaffViewHolder extends RecyclerView.ViewHolder {
        ...
        public StaffViewHolder(@NonNull View itemView, administratorpkg.recyclerviewonclick recyclerviewonclick) {
            super(itemView);
