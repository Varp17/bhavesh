...
public class teacher_feedback_adapter extends RecyclerView.Adapter<teacher_feedback_adapter.FeedbackViewHolder> {


    private List<Feedback> feedbackList;
    private OnFeedbackClickListener onFeedbackClickListener;

    public teacher_feedback_adapter(List<Feedback> feedbackList, OnFeedbackClickListener onFeedbackClickListener) {
